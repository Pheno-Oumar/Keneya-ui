...
export class CategorieActiviteService {
  ...
  ajouterCategorieActivite(categorie: CategorieActiviteInterface) {
    return this.http.post(`${this.apiUrl}/categorie-activites`, categorie, {
      withCredentials: true,
    });
  }
  getCategories(): Observable<CategorieActiviteResponseInterface> {
    return this.http.get<CategorieActiviteResponseInterface>(`${this.apiUrl}/categorie-activites`, {
      withCredentials: true,
    });
  }
  ...
  modifier(id: number, categorie: CategorieActiviteInterface) {
    return this.http.put(`${this.apiUrl}/categorie-activites/${id}`, categorie, {
      withCredentials: true,
    });
  }
}
